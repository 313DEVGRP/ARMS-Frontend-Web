...
// ARMS Poduct (service) 의 버전관리 : 서비스 선택 페이지 입니다.
// 루트 = '/version-control-choice'
// 
function VersionControlChoice() {
  const  wr_id  = 9; // 게시판 or 페이지 id
...
export default VersionControlChoice